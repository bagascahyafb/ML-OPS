...
st.set_page_config(page_title="Happiness Predictor", page_icon=":guardsman:", layout="centered")
...
def run():
    ...
    # Add tabs to the center of the container
    tabs = ["Predict", "Info"]
    page = container.tabs(tabs)
    ...
    with page[0]:
        ...
        with st.form("my_form"):
            st.write('**Let`s get started, this question below is in scale 1 to 5. which is 5 was you are very happy and 1 was you are not happy.**')
            ...
            if submitted:
                ...
                if output:
                    ...
                    st.image('images/happyresult.jpg', width=500)
                    ...
                    st.image('images/sadresult.jpg', width=500)
